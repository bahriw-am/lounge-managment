...
$connect = new PDO("mysql:host=localhost;dbname=food-order", "root", "");
 ...
 <body>
  ...
  <div class="container" style="padding-left:25%">
   <div class="row">
    ...
    ?>
     <div class="checkbox">
      <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_food-order"]; ?>" /> <?php echo $table["Tables_in_food-order"]; ?></label>
     </div>
    <?php
    }
    ?>
